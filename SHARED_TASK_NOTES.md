...
- **NOT in scope**: E2 (shared/ barrel — zero dedup value, P4 reject), E5 (Intl.NumberFormat consolidation — different rendering contracts, P4 reject), stockService C3 and i18n C2b _execution_ (this is a plan review; both remain backlog cards), /office-hours prerequisite (D1 defaulted to skip).
